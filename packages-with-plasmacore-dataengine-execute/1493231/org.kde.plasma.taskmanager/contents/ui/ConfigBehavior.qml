/*
 S PDX-F*ileCopyrightText: 2013 Eike Hein <hein@kde.org>
...
Item {
    ...
    ////by borealis
    property alias cfg_scrollingUpActiveTask: scrollingUpActiveTask.currentIndex
    property alias cfg_requestNewInstance: requestNewInstance.checked
    property alias cfg_restores: restores.checked
    property alias cfg_requestToggleMinimized: requestToggleMinimized.checked
    property alias cfg_requestClose: requestClose.checked
    //
    ...
    Kirigami.FormLayout {
        ...
        ////From Active Window Control by clearmartin
        ...
        CheckBox {
            ...
            Kirigami.FormData.label: i18n("Hide titlebar for maximized windows:")
            text: i18n("(takes effect immediately)")
            Layout.columnSpan: 2
            onCheckedChanged: {
        ...
        CheckBox {
            id: requestNewInstance
            Kirigami.FormData.label: i18nc("Part of a sentence: 'Mouse wheel'", "Scrolling up launchers:")
            text: i18nc("Part of a sentence: 'Mouse wheel opens a new instance'", "Opens a new instance")
        }

        CheckBox {
            id: restores
            Kirigami.FormData.label: i18nc("Part of a sentence: 'Mouse wheel'", "Scrolling up inactive task:")
            text: i18nc("Part of a sentence: 'Mouse wheel restores window or group'", "Restores window or group")
        }

        ComboBox {
            id: scrollingUpActiveTask
            Kirigami.FormData.label: i18n("Scrolling up active task:")
            Layout.fillWidth: true
            Layout.minimumWidth: Kirigami.Units.gridUnit * 14
            model: [
            i18nc("Part of a sentence: 'Scrolling-up active task does nothing'", "Does nothing"),
            i18nc("Part of a sentence: 'Scrolling-up active task opens a new instance'", "Opens a new instance"),
            i18nc("Part of a sentence: 'Scrolling-up active task Maximizes window or group'", "Maximizes window")
            ]
        }
        ...
        CheckBox {
            id: requestToggleMinimized
            Kirigami.FormData.label: i18nc("Part of a sentence: 'Mouse wheel'", "Scrolling down active task:")
            text: i18nc("Part of a sentence: 'Mouse wheel toggle maximized'", "Minimizes window or group")
        }

        CheckBox {
            id: requestClose
            Kirigami.FormData.label: i18nc("Part of a sentence: 'Mouse wheel'", "Scrolling down inactive task:")
            text: i18nc("Part of a sentence: 'Mouse wheel toggle maximized'", "Closes window or group")
        }
        //
