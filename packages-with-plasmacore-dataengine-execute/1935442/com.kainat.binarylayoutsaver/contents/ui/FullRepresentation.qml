         ...
         Row {
           ...
           PlasmaComponents.Button {
             ...
             onClicked: {
                        ...
                        var saveScript = dataPath+"/plasma/plasmoids/com.kainat.binarylayoutsaver/contents/scripts/save.sh";
                           ...
                           PlasmaComponents.Label {
                            ...
                            Column {
                                ...
                                onClicked: {
                                    ...
                                    var loadScript = dataPath+"/plasma/plasmoids/com.kainat.binarylayoutsaver/contents/scripts/load.sh";
