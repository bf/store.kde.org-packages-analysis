...
Item {
    ...
    PlasmaCore.IconItem {
        ...
        width: plasmoid.configuration.listIconSize
        height: width
    ...
    PlasmaComponents3.Label {
        id: titleElement
        visible:listItem.width>sidebarMinWidth
        anchors {
    ...
    PlasmaCore.SvgItem {
        ...
        visible: (listItem.managesChildrenOutside || (model.hasChildren === true))&&listItem.width>sidebarMinWidth
