...
Item {
    ...
    anchors.leftMargin:kickoffWidth-sidebarWidth>(leaveButtonsRow.implicitWidth+kickoffWidth)/2? PlasmaCore.Units.gridUnit:sidebarWidth*2-(leaveButtonsRow.implicitWidth+kickoffWidth)/2 +PlasmaCore.Units.gridUnit
    RowLayout {
        id: leaveButtonsRow
        anchors {
            centerIn: parent
