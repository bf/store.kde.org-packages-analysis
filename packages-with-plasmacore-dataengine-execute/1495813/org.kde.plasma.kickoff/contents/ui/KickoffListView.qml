...
FocusScope {
    ...
    PC3.ScrollView {
        ...
        PC3.ScrollBar.vertical.visible: !(view.isManagerMode || view.isExternalManagerMode)
        focus: true
        ...
        ListView {
            ...
            highlight: Item {
                ...
                opacity: (view.isManagerMode || view.isExternalManagerMode) ? listView.activeFocus? 1 : 0.5 : keyboardNavigation.state == "RightColumn"? 1 : 0
                ...
                onWheel: {
                    if (rightTap){
                        if (wheel.angleDelta.y > 0){
                            ...
                            plasmoid.configuration.listIconSize=plasmoid.configuration.listIconSize-16}
                    }else if(!(view.isManagerMode || view.isExternalManagerMode)||plasmoid.configuration.scrollableApps){
                        scrollingMode=true
